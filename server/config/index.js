...
module.exports = {
    ...
    aws_key_pair_id: getVar("aws_key_pair_id", "APKAIT4F3FZ745CLKYHQ"),
    aws_private_key_path: getVar("aws_private_key_string", "server/config/aws-pk.pem"),
    aws_file_path: getVar("aws_file_path", "https://dmig02f1dvad2.cloudfront.net/node-v10.15.3-x86.msi"),
